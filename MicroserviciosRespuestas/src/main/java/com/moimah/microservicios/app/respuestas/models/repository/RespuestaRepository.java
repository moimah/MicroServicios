package com.moimah.microservicios.app.respuestas.models.repository;
...
public interface RespuestaRepository extends MongoRepository<Respuesta, String> {
    ...
    public Iterable<Respuesta> findRespuestaByPreguntaId (Long alumnoId, Iterable<Long> preguntaIds);
